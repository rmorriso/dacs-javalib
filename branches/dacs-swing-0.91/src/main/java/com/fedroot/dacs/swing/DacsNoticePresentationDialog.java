...
public class DacsNoticePresentationDialog extends JDialog {
     ...
     */
    public DacsNoticePresentationDialog(Frame parent, String title, DacsClientContext dacscontext, DacsNotices notices) {
        ...
        System.out.println(notices.getPresentationReply());
//        setDocumentContent("text/html", notices.getPresentationReply().);
        validate();
...
//        this.dialogInit();
     ...
     * @param parent window from which this dialog is launched
     */
    public DacsNoticePresentationDialog(Frame parent, DacsClientContext dacscontext, DacsNotices notices) {
     ...
     */
    public DacsNoticePresentationDialog(DacsClientContext dacscontext, DacsNotices notices) {
