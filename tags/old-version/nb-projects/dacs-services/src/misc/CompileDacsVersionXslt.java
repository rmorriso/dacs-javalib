...
/*
 * Run this file to generate class com.fedroot.dacs.xsl.DacsVersionXslt
 * from xsl/dacs_version.xslt.
 *
 * NOTE - DO NOT PUT THE COMPILE CLASS IN THE SAME PACKAGE AS THE
 * XSLTC CLASSES THAT IT GENERATES
 */
public class CompileDacsVersionXslt {
    ...
    public static void main(String[] args) throws Exception{
        ...
        File xmlfile = new File("H:/projects/dacs-javalib/projects/dacs-services/xsl/dacs_version_test.xml");

        DocumentBuilder builder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
        Document doc = builder.parse(xmlfile);
        
        File stylefile = new File("H:/projects/dacs-javalib/projects/dacs-services/xsl/dacs_version.xslt");
        // Get an input stream for the XSL stylesheet
	StreamSource stylesheet = new StreamSource(stylefile);
        
        TransformerFactory transfact = TransformerFactory.newInstance();
        transfact.setAttribute(TRANSLET_NAME, "DacsVersionXslt");
