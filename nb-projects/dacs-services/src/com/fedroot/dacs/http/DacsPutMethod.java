...
/**
 * DACS-aware subclass of HttpClient PutMethod
 * @author rmorriso
 */
public class DacsPutMethod extends PutMethod {
    NameValueSet nvs;
     ...
     */
    public DacsPutMethod(String uri) {
        super(uri);
     ...
     */
    public DacsPutMethod(String uri, NameValueSet nvs) 
    throws Exception {
        super(uri);
        this.nvs = nvs;
