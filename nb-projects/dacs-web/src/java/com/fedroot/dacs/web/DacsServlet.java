...
public abstract class DacsServlet extends HttpServlet {
    ...
    /**
     * Overrides the HTTP <code>GET</code> method.
     * @param request servlet request
     * @param response servlet response
     */
    ...
    throws ServletException, IOException {
        ...
        // note: we expect processRequest to populate the HTML response
        try {
            // set Event902Handler
            usercontext.setDacs902EventHandler(new Event902Handler(request, response));
