...
/**
 * DACS-aware subclass of HttpClient DeleteMethod
 * @author rmorriso
 */
public class DacsDeleteMethod extends DeleteMethod {
    NameValueSet nvs;
    
    /**
     * constructor for DacsPutMethod;
     ...
     */
    public DacsDeleteMethod(String uri) {
        super(uri);
     ...
     */
    public DacsDeleteMethod(String uri, NameValueSet nvs) 
    throws Exception {
        super(uri);
        this.nvs = nvs;
