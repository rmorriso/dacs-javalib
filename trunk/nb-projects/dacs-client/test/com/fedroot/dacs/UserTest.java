...
public class UserTest extends TestCase {
    ...
    public void testAuthenticate() {
        ...
        try {
            ...
            assertEquals(2, testuser.getDacsCredentials(mljur));
            assertEquals(1, testuser.getDacsCredentials(dssjur));
        } catch (Exception e) {
    ...
    public void testSignout() {
        ...
        try {
            ...
            int n1 = testuser.signout(dssjur);
            assertEquals(1, n1);
            n1 = testuser.getDacsCredentials().size();
