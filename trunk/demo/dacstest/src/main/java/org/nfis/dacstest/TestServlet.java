...
public class TestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            FederationLoader federationLoader = new FederationLoader("https://ca.nfis.org/cgi-bin/dacs", dacsClientContext);
            ...
            for (Jurisdiction jurisdiction : federation.getJurisdictions()) {
                out.println(jurisdiction.toString());
            }
            out.println("</body>");
            out.println("</html>");
