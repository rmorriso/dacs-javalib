 ...
 * @see StatusBar
 */
public class DacsSingleFrameApplication extends SingleFrameApplication {

    private static final Logger logger = Logger.getLogger(DacsSingleFrameApplication.class.getName());
   ...
   private Federation currentFederation;
    ...
    protected void startup() {
        try {
            ...
            Logger.getLogger(DacsSingleFrameApplication.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(DacsSingleFrameApplication.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        gotoButton.setName("GOTO");
    ...
    private class DoNothingTask extends Task<Void, Void> {
        ...
        DoNothingTask() {
            super(DacsSingleFrameApplication.this);
...
//            }
    ...
    public static void main(String[] args) {
        Application.launch(DacsSingleFrameApplication.class, args);
    }
